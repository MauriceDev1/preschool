    ...
    <div>
      ...
      <div className='w-full py-10 flex'>
        <div className='flex w-10/12 mx-auto'>
            ...
            <div className="w-5/12 h-96 mt-12" style={{backgroundImage: 'url(https://scontent-cpt1-1.xx.fbcdn.net/v/t39.30808-6/243404081_256456103154955_2878214536234576043_n.jpg?stp=dst-jpg_s960x960&_nc_cat=109&ccb=1-7&_nc_sid=e3f864&_nc_ohc=iIn07Am64m8AX-FXLAG&_nc_ht=scontent-cpt1-1.xx&oh=00_AfDPUZGKMsf1y8f01HpcMGDKadQat587xiyqFTBaDKLtZg&oe=638B0B66)', backgroundSize: 'cover'}}>
            </div>
        </div>
      </div>
    </div>
